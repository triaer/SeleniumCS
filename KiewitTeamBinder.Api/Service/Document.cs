...
namespace KiewitTeamBinder.Api.Service
{
    ...
    {
        #region Entities
        public DocumentServiceReference.DocumentWebServiceSoapClient request = new DocumentServiceReference.DocumentWebServiceSoapClient("DocumentWebServiceSoap");
        #endregion
        ...
        public DataTable ListDocumentsAll(string sessionKey, string[] fieldNamesWithValues = null, string[] dateTimeFieldNamesWithValues = null, string registerView = "ALL")
        {
            ...
            DataTable dataTableResponse = request.ListDocumentsAll(sessionKey, documentFilter, registerView, orderBy, startRowPosition, noOfRows);            
