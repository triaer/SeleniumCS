    ...
    public class FilteringAndExporting : UITestBase
    {
        ...
        public void VendorDataRegister_FilteringAndExporting_UI()
        {
            try
            {
                ...
                //                  .DoubleClickItem(filteringAndExportingData.ItemID, filteringAndExportingData.GridViewItemGrid, filteringAndExportingData.ItemDescription)
                //                  .LogValidation<VendorDataRegister>(ref validations, vendorDataRegister.ValidateBredCrumbTrailDisplayCorrect(filteringAndExportingData.Deliverables, false, filteringAndExportingData.ContractNumber, filteringAndExportingData.ItemID));
                //VendorDeliverableDetail vendorDeliverableDetail = vendorDataRegister.ClickOnBlueItem<VendorDeliverableDetail>(filteringAndExportingData.GridViewDeliverableGrid, filteringAndExportingData.DeliverableNumber);
                ...
                //DocumentDetail documentDetail = vendorDataRegister.ClickOnBlueItem<DocumentDetail>(filteringAndExportingData.GridViewDocumentGrid, documentNo);
                ...
                //    .LogValidation<VendorDataRegister>(ref validations, vendorDataRegister.ValidateItemsCountedAreMatches(filteringAndExportingData.GridExpeditingContracts))
                ...
                //    .DownloadFile<VendorDataRegister>(filteringAndExportingData.DownloadFilePath)
                //    .LogValidation<VendorDataRegister>(ref validations, vendorDataRegister.ValidateExcelItemsCount(filteringAndExportingData.GridExpeditingContracts, filteringAndExportingData.DownloadFilePath))
                //    .LogValidation<VendorDataRegister>(ref validations, vendorDataRegister.ValidateDataExcelCorrectly(filteringAndExportingData.GridExpeditingContracts, filteringAndExportingData.DownloadFilePath));
                ...
                //           .SelectModuleMenuItemOnLeftNav<Dashboard>(ModuleNameInLeftNav.DASHBOARD.ToDescription());
